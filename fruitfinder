...
vu3.Info:AddButton({
    ["Title"] = "DinoHUB",
    ["Description"] = "Mua Hack",
    ["Callback"] = function()
        setclipboard(tostring("https://dinokey.x10.mx"))
    end
})
vu3.Info:AddButton({
    ["Title"] = "Dino Roblox",
    ["Description"] = "Youtube",
    ["Callback"] = function()
        setclipboard(tostring("mẹ mày béo"))
    end
})
vu3.Info:AddButton({
    ["Title"] = "DinoHUB",
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("lol"))
    end
})
vu3.Info:AddParagraph({
    ["Title"] = "Ph\195\161t tri\225\187\131n Dino",
...
vu3.Main:AddToggle("ToggleMobAura", {
    ["Title"] = "\239\191\189\195\161nh Qu\195\161i \225\187\158 G\225\186\167n",
    ["Description"] = "",
    ["Default"] = false
...
vu3.Main:AddToggle("ToggleMasteryFruit", {
    ["Title"] = "C\195\160y Th\195\180ng Th\225\186\161o Tr\195\161i",
    ["Description"] = "",
    ["Default"] = false
...
vu3.Main:AddToggle("ToggleMasteryGun", {
    ["Title"] = "C\195\160y Th\195\180ng Th\225\186\161o S\195\186ng",
    ["Description"] = "",
    ["Default"] = false
...
local v328 = vu3.Main:AddSlider("SliderHealt", {
    ["Title"] = "Ch\225\187\141n M\195\161u Qu\195\161i",
    ["Description"] = "",
    ["Default"] = 20,
    ["Min"] = 0,
    ["Max"] = 100,
...
if Sea3 then
    ...
    spawn(function()
        ...
        pcall(function()
            ...
            while wait() do
                ...
                vu426:SetDesc("B\225\186\161n C\195\179: " .. tostring(v427) .. " X\198\176\198\161ng")
            end
        end)
    end)
    ...
    vu3.Main:AddToggle("ToggleRandomBone", {
        ["Title"] = "T\225\187\177 \196\144\225\187\153ng Random X\198\176\198\161ng",
        ["Description"] = "",
        ["Default"] = false
...
if Sea3 then
    ...
    local vu441 = vu3.Main:AddParagraph({
        ["Title"] = "Tr\225\186\161ng Th\195\161i Boss Ra",
        ["Content"] = ""
    })
    spawn(function()
		-- upvalues: (ref) vu441
...
if Sea3 then
    ...
    vu3.Sea:AddToggle("ToggleTPKitsune", {
        ["Title"] = "Bay V\195\160o \196\144\225\186\163o C\195\161o",
        ["Description"] = "",
        ["Default"] = false
    ...
    v555("T\195\172m \196\144\225\186\163o Dung Nham", "AutoFindPrehistoric", v520.Prehistoric, "PrehistoricIsland", "\239\191\189\225\186\163o Dung Nham \196\144\195\163 \196\144\198\176\225\187\163c T\195\172m Th\225\186\165y")
    v555("T\195\172m \196\144\225\186\163o B\195\173 \225\186\168n", "AutoFindMirage", v520.Mirage, "MysticIsland", "\239\191\189\225\186\163o B\195\173 \225\186\168n \196\144\195\163 \196\144\198\176\225\187\163c T\195\172m Th\225\186\165y")
    v555("T\195\172m \196\144\225\186\163o Leviathan", "AutoFindFrozen", v520.Frozen, "FrozenDimension", "\239\191\189\225\186\163o Leviathan \196\144\195\163 \196\144\198\176\225\187\163c T\195\172m Th\225\186\165y")
    ...
    vu3.Sea:AddButton({
        ["Title"] = "Bay \196\144\225\186\191n Khu V\225\187\177c Mua Thuy\225\187\129n",
        ["Description"] = "",
        ["Callback"] = function()
    ...
    vu3.Sea:AddToggle("ToggleTerrorshark", {
        ["Title"] = "\239\191\189\195\161nh C\195\161 M\225\186\173p T\225\186\173n Th\225\186\191",
        ["Description"] = "",
        ["Default"] = false
...
vu3.Item:AddToggle("ToggleAutoDualKatana", {
    ["Title"] = "Song Ki\225\186\191m Nguy\225\187\129n R\225\187\167a",
    ["Description"] = "",
    ["Default"] = false
...
vu3.Setting:AddToggle("ToggleAutoKen", {
    ["Title"] = "B\225\186\173t Haki Quan S\195\161t",
    ["Description"] = "",
    ["Default"] = false
...
vu3.Setting:AddToggle("ToggleRemoveNotify", {
    ["Title"] = "T\225\186\175t Th\195\180ng B\195\161o",
    ["Description"] = "",
    ["Default"] = false
...
local vu879 = vu3.Status:AddParagraph({
    ["Title"] = "Th\225\187\157i Gian D\195\185ng Script",
    ["Content"] = ""
})
